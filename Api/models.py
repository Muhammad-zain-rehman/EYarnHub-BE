...
#     products = models.ManyToManyField(Products, related_name='hospitals_products', db_column="HospitalProducts",
#                                       blank=True)
...
#     code = models.SlugField(max_length=225, null=True, blank=True, default=None)
#
#     class Meta:
#         db_table = 'Solution'
#
...
#         try:
#             if not self.pk:
#                 self.code = slugify(self.solution)
#             super().save()
#         except Exception:
#             raise
#
...
#         try:
#             if not self.pk:
#                 self.code = slugify(self.audience)
#             super().save()
#         except Exception:
#             raise
#
